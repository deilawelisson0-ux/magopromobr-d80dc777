    ...
    <main className="relative min-h-screen w-full overflow-hidden text-white">
      ...
      <div className="relative z-10 mx-auto flex min-h-[100dvh] w-full max-w-[440px] flex-col items-center justify-center px-5 py-3 sm:max-w-[520px]">
        ...
        <div className="relative mt-2 block h-[160px] w-[160px] leading-none sm:h-[200px] sm:w-[200px]">
          {/* GOLD RING — outer diffuse glow */}
          <div
            aria-hidden
            className="pointer-events-none absolute -inset-[38%] -z-10 rounded-full animate-gold-breath"
            style={{
              background:
                "radial-gradient(circle, rgba(255,196,80,0.20) 0%, rgba(255,180,60,0.10) 42%, rgba(255,170,50,0.04) 62%, transparent 78%)",
              filter: "blur(22px)",
            }}
          />
          {/* GOLD RING — soft halo hugging the ring */}
          <div
            aria-hidden
            className="pointer-events-none absolute -inset-[12%] -z-10 rounded-full animate-gold-breath"
            style={{
              background:
                "radial-gradient(circle, transparent 52%, rgba(255,214,120,0.38) 68%, rgba(255,190,80,0.16) 80%, transparent 92%)",
              filter: "blur(10px)",
              animationDelay: "1.6s",
            }}
          />
          {/* GOLD RING — metallic ring with travelling light reflection */}
          <div
            aria-hidden
            className="pointer-events-none absolute -inset-[5%] -z-10 rounded-full animate-gold-sweep"
            style={{
              background:
                "conic-gradient(from 0deg, rgba(158,108,20,0.85) 0deg, rgba(214,168,58,0.95) 38deg, rgba(255,232,168,1) 66deg, rgba(255,255,245,1) 78deg, rgba(255,226,150,1) 92deg, rgba(196,148,44,0.9) 140deg, rgba(140,96,18,0.8) 190deg, rgba(226,182,84,0.95) 250deg, rgba(255,244,214,1) 286deg, rgba(210,160,52,0.9) 320deg, rgba(158,108,20,0.85) 360deg)",
              WebkitMaskImage:
