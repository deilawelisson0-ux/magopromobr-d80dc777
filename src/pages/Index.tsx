...
const Index = () => {
  ...
  className="w-full flex items-center justify-center gap-3 py-5 rounded-2xl bg-[#25D366] text-white font-bold text-lg shadow-2xl hover:scale-105 active:scale-95 transition"
>
            <svg
