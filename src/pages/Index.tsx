...
const Index = () => {
  ...
  return (
    <div className="bg-background flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center lg:items-start w-full max-w-[1200px] mx-auto px-3 lg:px-8 py-0 pb-24 overflow-hidden" style={{ gap: '0.6vh' }}>
        ...
        <section className="text-center lg:text-left shrink-0 w-full">
          <h2 className="text-[15px] sm:text-xl lg:text-6xl font-black text-foreground leading-tight max-w-4xl lg:max-w-4xl">
          ...
          <p className="text-[8px] sm:text-[10px] lg:text-base text-foreground/50 font-medium mt-0.5">
        ...
        <div className="w-full flex flex-col lg:flex-row gap-3 lg:gap-10 items-stretch flex-1 min-h-0 mt-2 lg:mt-8">
          ...
          <div className="w-full lg:flex-[2.2] min-w-0 flex items-center justify-center relative">
            ...
            <img
              ...
              className="w-full lg:max-w-[1100px] h-auto object-cover relative z-10 rounded-2xl glow-gold-border"
              loading="eager"
            />
          </div>
    ...
    <div key={b.text} className="flex items-center gap-1 bg-card/60 border border-border rounded-md px-1.5 py-0.5">
      ...
      <span className="text-[8px] sm:text-[11px] font-semibold text-foreground">{b.text}</span>
        ...
        <div className="fixed bottom-0 left-0 w-full px-3 pb-3 z-50 bg-background/80 backdrop-blur-sm lg:static lg:bg-transparent lg:backdrop-blur-0 lg:px-0 lg:pb-0 lg:mt-2">
          <button
            onClick={handleCTA}
            className="animate-button-pulse w-full lg:max-w-md lg:mx-auto text-center font-extrabold text-sm sm:text-lg lg:py-5 py-3.5 lg:py-4 rounded-2xl bg-green-500 text-white shadow-lg shadow-green-500/30 transition-all duration-200 hover:scale-[1.05] active:scale-[0.97]"
          >
